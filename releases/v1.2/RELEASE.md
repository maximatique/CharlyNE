# Release v1.2 — 2026-09-06

## Statut

Version techniquement validée et approuvée pour dépôt GitHub.

Le drapeau `legal_review_required` reste présent dans le manifeste runtime conformément à la spécification v1.2 ; cette validation ne vaut pas relecture juridique du cadre électoral.

## Contrôles effectués

- Skill ChatGPT/Codex : validateur Skill OK.
